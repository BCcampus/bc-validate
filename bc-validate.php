 ...
 * Dashboard. This file also inc all of the dependencies used by the plugin,
...
function activate_bc_validate() {
	require_once plugin_dir_path( __FILE__ ) . 'inc/class-bc-validate-activator.php';
...
function deactivate_bc_validate() {
	require_once plugin_dir_path( __FILE__ ) . 'inc/class-bc-validate-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'inc/class-bc-validate.php';
